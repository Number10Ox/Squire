...
//     version 1.9.0
//     from Assets/Scripts/Components/InputHandling/SquireInputActions.inputactions
//
...
public partial class @SquireInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@SquireInputActions()
    {
        Debug.Assert(!m_DungeonMap.enabled, "This will cause a leak and performance issues, SquireInputActions.DungeonMap.Disable() has not been called.");
    }
